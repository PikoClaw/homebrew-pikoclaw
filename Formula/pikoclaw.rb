class Pikoclaw < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "dc7a2ee2d22acfce6c42634b8fbb661237c78fd461f8616a9b2997bab1983364"
    end
    on_intel do
      url "https://github.com/PikoClaw/pikoclaw/releases/download/v#{version}/pikoclaw-macos-x86_64"
      sha256 "6927c3caa8e5f5f4759257f0abd3690d6c08d63c3c4bbf3d6c818a91644e3112"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "3e381aff0062aeede7396589cdec333674ec9298dae7c5185d7134397fd2f928"
    end
  end
