class Pikoclaw < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "d76e873486f45b828f8bf93751dcb0d241bd5d953bb7f18c4a75c23f853ee521"
    end
    on_intel do
      url "https://github.com/PikoClaw/pikoclaw/releases/download/v#{version}/pikoclaw-macos-x86_64"
      sha256 "dcbc224e4dcadbcd645a87ba1307bf8c2e15fdff04cf4afd3bde4d365526f0d5"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "cbaddc9a757f74fa0da76310c1f40d237544c91b0cc1ffee56bb832e58c3d93d"
    end
  end
